...
$sql = "SELECT * FROM block WHERE member_id='$id'";
...
$sql = "INSERT INTO members(member_id,password,name,mobile,email,gender,phone_pay_no,google_pay_no,paytm_no,bank_name,acc_no,branch,ifsc_code,sponcer,joining_date,level,sponcer_info)
    ...
    ";
if ($conn->query($sql)) {
    $sql = "DELETE FROM block WHERE member_id='$id'";
    $conn->query($sql);
